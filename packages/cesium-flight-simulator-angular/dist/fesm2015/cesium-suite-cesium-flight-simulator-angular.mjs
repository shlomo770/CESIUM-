...
function getTerrainHeightSafe(viewer, longitude, latitude) {
    ...
    try {
        ...
        return (_a = viewer.scene.globe.getHeight(cartographic)) !== null && _a !== void 0 ? _a : 0;
    }
    catch (_b) {
        return 0;
    }
...
class FlightStateService {
    ...
    applyExternalTelemetry(telemetry) {
        ...
        const next = Object.assign(Object.assign({}, state), { mode: "EXTERNAL", latitude: telemetry.latitude, longitude: telemetry.longitude, altitudeM: telemetry.altitudeM, headingDeg: telemetry.headingDeg, pitchDeg: telemetry.pitchDeg, rollDeg: telemetry.rollDeg, speedMps: typeof telemetry.speedMps === "number" ? telemetry.speedMps : state.speedMps });
        this.pushTrail(next);
    ...
    tickFlight(dtSeconds, inputs, terrainHeightM) {
        ...
        const next = Object.assign(Object.assign({}, state), { speedMps, throttle: (speedMps - cfg.minSpeedMps) / (cfg.maxSpeedMps - cfg.minSpeedMps), headingDeg, latitude: nextPoint.latitude, longitude: nextPoint.longitude, altitudeM });
        this.pushTrail(next);
        this.subject.next(next);
    }
    pitchUpStep() {
    ...
    patchAttitude(partial) {
        const next = Object.assign(Object.assign({}, this.snapshot), partial);
        this.pushTrail(next);
        this.subject.next(next);
    }
    patch(partial) {
        this.subject.next(Object.assign(Object.assign({}, this.snapshot), partial));
    }
    pushTrail(state) {
...
class CesiumSceneComponent {
    ...
    ngOnDestroy() {
        var _a;
        (_a = this.flightSub) === null || _a === void 0 ? void 0 : _a.unsubscribe();
    ...
    syncFlightToScene(flight) {
        ...
        if ((_a = this.sideGround) === null || _a === void 0 ? void 0 : _a.polyline) {
...
class FlightSimulatorWidgetComponent {
    ...
    applyConfig() {
        ...
        this.viewMode = this.initialViewMode;
        const effectiveMode = (_a = this.mode) !== null && _a !== void 0 ? _a : this.mergedConfig.mode;
