...
var ChaseCamera = class {
  ...
  constructor(config) {
    ...
    this.config = config;
    this.camera = new three.PerspectiveCamera(config.fov, 1, 0.1, 8e3);
...
var SceneManager = class {
  ...
  setupLights() {
    const { environment } = this.config;
    const ambient = new three.AmbientLight(16777215, environment.ambientIntensity);
    ...
    if (environment.showGrid) {
      this.grid = new three.GridHelper(240, 48, 3359061, 1976635);
...
exports.ALTITUDE_WORLD_SCALE = ALTITUDE_WORLD_SCALE;
exports.AircraftLoader = AircraftLoader;
exports.ChaseCamera = ChaseCamera;
exports.DEFAULT_DEMO_MODEL_URL = DEFAULT_DEMO_MODEL_URL;
exports.DEFAULT_TELEMETRY = DEFAULT_TELEMETRY;
exports.DragController = DragController;
exports.EmbeddedHost = EmbeddedHost;
exports.FloatingHost = FloatingHost;
exports.LifecycleManager = LifecycleManager;
exports.OverlayManager = OverlayManager;
exports.SceneManager = SceneManager;
exports.TelemetryFlightViewer = TelemetryFlightViewer;
exports.TelemetryState = TelemetryState;
exports.createTelemetrySnapshot = createTelemetrySnapshot;
exports.createViewerRoot = createViewerRoot;
exports.createViewerViewport = createViewerViewport;
exports.disposeMaterial = disposeMaterial;
exports.disposeNodeResources = disposeNodeResources;
exports.disposeObject3D = disposeObject3D;
exports.disposeTexture = disposeTexture;
exports.getDefaultUiConfig = getDefaultUiConfig;
exports.isValidTelemetryUpdate = isValidTelemetryUpdate;
exports.normalizeHeadingDegrees = normalizeHeadingDegrees;
